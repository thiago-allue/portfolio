...
class GeneticFunctionsMixin:
    @staticmethod
    def probability_crossover():
    ...
    def crossover(self, parents):
        """ Perform crossover - breed children """
        return parents
...
class GuessText(GeneticFunctionsMixin):
    """ Mapped guess prepared Text """

    def __init__(
        self, target_text, limit=200, size=400, prob_crossover=0.9, prob_mutation=0.2,
    ):
